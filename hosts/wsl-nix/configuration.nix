...

{
  ...
  #
  # The OMP coding agent (omp) is installed via its native self-updating
  # installer to ~/.local/bin and run through nix-ld — both provided by the
  # shared baseline (programs.nix-ld + ~/.local/bin on PATH), same as every host.
